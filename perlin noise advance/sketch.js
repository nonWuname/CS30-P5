...
function generateTerrain(temprecttime,version){
  ...
  for(let i = 0; i < width; i+=rectwidth){
    ...
    if(version == 1)fill(map(i,0,width,255,0),map(i*2,0,width,160,255),map(i*3,0,width,120,255));
    else if(version == 2)fill(map(i,0,width,0,255),map(i*2,0,width,255,161),map(i*3,0,width,255,120));
    else if(version == 3)fill(map(i,0,width,180,0),map(i*2,0,width,230,47),map(i*3,0,width,161,47));
    //draw rect
